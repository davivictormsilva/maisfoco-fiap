...
import br.com.maisfoco.dao.DespesaDAO;
...
public class TesteDespesa {
    public static void main(String[] args) {
        ...
        Long contaId = ensureConta(userId, "Conta Principal", "CORRENTE", 0.0);

        DespesaDAO dao = new DespesaDAO();
        dao.insert(new Despesa("Mercado",     120.30, Date.valueOf("2025-10-02"), contaId, userId, catId));
        dao.insert(new Despesa("Transporte",   18.00, Date.valueOf("2025-10-03"), contaId, userId, catId));
        dao.insert(new Despesa("Lanche",       25.50, Date.valueOf("2025-10-05"), contaId, userId, catId));
        dao.insert(new Despesa("Internet",     99.99, Date.valueOf("2025-10-08"), contaId, userId, catId));
        dao.insert(new Despesa("Energia",     160.00, Date.valueOf("2025-10-10"), contaId, userId, catId));

        List<Despesa> lista = dao.getAll();
        for (Despesa d : lista) System.out.println(d);
    }
